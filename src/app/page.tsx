    ...
    <div className="overflow-x-hidden">
      ...
      <section className="py-20" id="branches">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <FadeInSection>
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 text-center font-serif-alt mb-12">
              {t('Visit Us at Either Branch', 'زورنا في أي من الفرعين')}
            </h2>
          </FadeInSection>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <FadeInSection key={i} delay={i * 150}>
                <div className="branch-card group">
                  <div className={`h-36 bg-gradient-to-br ${branch.gradient} flex items-center justify-center relative overflow-hidden`}>
                    <span className="text-5xl relative z-10">{branch.emoji}</span>
                    <div className="absolute inset-0 bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </div>
                  <div className="p-5">
                    <h3 className="font-bold text-slate-900 text-lg">{branch.name}</h3>
                    <p className="text-sm text-slate-500 mt-1">{branch.addr}</p>
